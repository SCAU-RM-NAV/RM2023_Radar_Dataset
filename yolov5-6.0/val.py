...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/armor_data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'armorbestv4.pt', help='model.pt path(s)')
